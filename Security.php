...
class Security {
	 ...
	 * @var string
	 */
	protected $_csrf_token_name =	'our_csrf_token';
	 ...
	 * @var string
	 */
	protected $_csrf_cookie_name =	'our_csrf_token';

	/**
	 * CSRF Protection enabled / not
	 *
	 * @var boolian
	 */
	protected $_csrf_enabled =	true;
	...
	public function csrf_set_cookie()
	{
		...
		$secure_cookie = ($_SERVER['REQUEST_SCHEME'] == 'https') ? true : false;
...
/* Location: Util/Form/Security.php */